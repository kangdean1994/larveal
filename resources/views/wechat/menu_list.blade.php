...
<center>
    ...
    <form action="{{url('Wechat/do_add_menu')}}" method="post" align="center">
        @csrf
    ...
    <br><br>
    <h3>菜单展示</h3>
    <form action="{{url('Wechat/reload_menu')}}" method="get">
    <table border="1" width="1000">
        ...
        <tr>
            ...
            <td>{{$v['event_type']}}</td>
            <td>{{$v['menu_tag']}}</td>
            <td><a href="{{url('Wechat/menu_del')}}?id={{$v['menu_type']}}">删除</a></td>
        </tr>
        @endforeach
